...
const QUESTIONS = [
  { question: "Do I need experience?", answer: "Expectations vary by subteam. Software considers technical curiosity, relevant skills and projects, problem-solving and team fit. Power Architecture asks for electrical fundamentals, PCB-tool experience and hands-on assembly skills. Read the role descriptions before applying." },
